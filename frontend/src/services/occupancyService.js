...
export function normalizeOccupantRecord(row = {}) {
  ...
  return {
    ...
    staffId,
    wpPpNo: String(firstDefined(row.wpPpNo, row.wp_pp_no, row['WP/PP No'], '') || ''),
    phone: String(firstDefined(row.phone, row.phone_no, row['Phone'], '') || ''),
    name,
